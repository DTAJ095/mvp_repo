          ...
          SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // Onboarding pages
                const ExploreAfricaPage(),
                const BookWithEasePage(),
                const StayWithAfricaPage(),
                const SizedBox(
...
class ExploreAfricaPage extends StatelessWidget {
  const ExploreAfricaPage({super.key});
...
class BookWithEasePage extends StatelessWidget {
  const BookWithEasePage({super.key});
...
class StayWithAfricaPage extends StatelessWidget {
  const StayWithAfricaPage({super.key});
